      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            runSpacing: 4,
            children: [
              KeepersText('Created ${_formatDate(memory.metadata.createdAt)}'),
              KeepersText(memory.metadata.privacy.vaultLabel),
            ],
          ),
    ...
    child: Column(
      children: [
        ...
        FilledButton.icon(
          ...
          label: const KeepersText('Play voice memory'),
        ),
    ...
    child: SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          KeepersText(message, textAlign: TextAlign.center),
        ],
      ),
    ),
  );
