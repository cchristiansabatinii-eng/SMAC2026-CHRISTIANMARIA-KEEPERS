    ...
    final base = ThemeData(
      ...
      colorScheme: brightness == Brightness.dark
          ...
          : ColorScheme.fromSeed(
              seedColor: KeepersColors.ink,
              brightness: brightness,
            ).copyWith(
              primary: KeepersColors.ink,
              onPrimary: KeepersColors.auraIvory,
              primaryContainer: KeepersColors.ink,
              onPrimaryContainer: KeepersColors.auraIvory,
              secondary: KeepersColors.ink,
              onSecondary: KeepersColors.auraIvory,
              secondaryContainer: KeepersColors.ink,
              onSecondaryContainer: KeepersColors.auraIvory,
              tertiary: KeepersColors.ink,
              onTertiary: KeepersColors.auraIvory,
              tertiaryContainer: KeepersColors.ink,
              onTertiaryContainer: KeepersColors.auraIvory,
              outline: KeepersColors.ink,
              outlineVariant: KeepersColors.ink,
              surfaceTint: KeepersColors.ink,
            ),
