...
class FlutterBlePeripheralManager(
     ...
     *
     * Android returns null while Bluetooth is off. Resolve this for every use
     * so a manager created while Bluetooth was off can advertise after the
     * user enables it, and treat a concurrently revoked permission as absent.
     */
    ...
    fun start(
        ...
        if (advertiser == null) {
            mAdvertiseCallback.onStartFailure(
    ...
    fun startSet(
        ...
        val advertiser = bluetoothLeAdvertiser
        if (advertiser == null) {
            mAdvertiseSetCallback.onAdvertisingSetStarted(
                null,
                0,
