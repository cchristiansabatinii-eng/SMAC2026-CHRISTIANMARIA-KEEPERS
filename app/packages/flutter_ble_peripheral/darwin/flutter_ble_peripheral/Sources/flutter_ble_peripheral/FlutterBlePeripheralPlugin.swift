...
public class FlutterBlePeripheralPlugin: NSObject, FlutterPlugin {
    ...
    private lazy var flutterBlePeripheralManager: FlutterBlePeripheralManager = {
        FlutterBlePeripheralManager(
            stateChangedHandler: self.stateChangedHandler,
            dataReceivedHandler: self.dataReceivedHandler,
            mtuChangedHandler: self.mtuChangedHandler,
            subscriptionChangedHandler: self.subscriptionChangedHandler
        )
    }()
