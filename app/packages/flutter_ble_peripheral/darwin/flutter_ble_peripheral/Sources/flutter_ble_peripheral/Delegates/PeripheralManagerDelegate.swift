...
extension FlutterBlePeripheralManager: CBPeripheralManagerDelegate {
    ...
    func peripheralManagerDidStartAdvertising(_ peripheral: CBPeripheralManager, error: (any Error)?) {
        ...
        guard error == nil else {
            // Core Bluetooth reports the actual asynchronous start result here.
            // Publishing idle lets Dart fail closed instead of treating the
            // accepted request as proof that the rotating UUID is on air.
